var Constants = {
  ...
  // Device Constants
  DEVICE_ID_HA_ON_OFF_SWITCH: 0x0000,
  DEVICE_ID_HA_LEVEL_CONTROL_SWITCH: 0x0001,
  DEVICE_ID_HA_ON_OFF_OUTPUT: 0x0002,
  DEVICE_ID_HA_LEVEL_CONTROLLABLE_OUTPUT: 0x0003,
  DEVICE_ID_HA_SCENE_SELECTOR: 0x0004,
  DEVICE_ID_HA_CONFIGURATION_TOOL: 0x0005,
  DEVICE_ID_HA_REMOTE_CONTROL: 0x0006,
  DEVICE_ID_HA_COMBINED_INTERFACE: 0x0007,
  DEVICE_ID_HA_RANGE_EXTENDER: 0x0008,
  DEVICE_ID_HA_MAINS_POWER_OUTLET: 0x0009,
  DEVICE_ID_HA_DOOR_LOCK: 0x000A,
  DEVICE_ID_HA_DOOR_LOCK_CONTROLLER: 0x000B,
  DEVICE_ID_HA_SIMPLE_SENSOR: 0x000C,
  DEVICE_ID_HA_CONSUMPTION_AWARENESS_DEVICE: 0x000D,
  DEVICE_ID_HA_HOME_GATEWAY_ENERGY_MANAGEMENT_SYSTEM: 0x0050,
  DEVICE_ID_HA_SMART_PLUG: 0x0051,
  DEVICE_ID_HA_WHITE_GOODS: 0x0052,
  DEVICE_ID_HA_WINDOW_COVERING: 0x0202,
  ...
  DEVICE_ID_LIGHT_SENSOR: 0x0106,
  DEVICE_ID_DOOR_LOCK: 0xa,
  DEVICE_ID_HA_ON_OFF_LIGHT: 0x0103,
  DEVICE_ID_EXTENDED_COLOR_LIGHT: 0x0210,
  DEVICE_ID_COLOR_TEMPERATURE_LIGHT: 0x0220,
  DEVICE_ID_ZLL_COLOR_LIGHT: 0x0200,
  DEVICE_ID_ZLL_COLOR_SCENE_CONTROLLER: 0x0800,
  DEVICE_ID_ZLL_NON_COLOR_SCENE_CONTROLLER: 0x0830,
  
  DEVICE_ID_LO_SCENE_CONTROLLER: 0x0810,
  DEVICE_ID_LO_COLOR_TEMPERATURE_LIGHT: 0x010c,
  DEVICE_ID_LO_EXTENDED_COLOR_LIGHT: 0x010d,
  DEVICE_ID_LO_DIMMER_SWITCH: 0x0104,
